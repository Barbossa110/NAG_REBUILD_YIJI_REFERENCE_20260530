  ...
  return (
    ...
    >
      <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="archive-panel p-6 md:p-8 lg:p-9">
          ...
          <div className="flex min-h-full flex-col justify-between gap-10">
            <div>
              ...
              <p className="body-copy mt-4 max-w-sm">
                微信扫码可直接联系 NAG。
                <br />
                Scan to contact NAG directly on WeChat.
              </p>
            </div>
            <Image
              ...
              width={924}
              height={924}
              className="mx-auto h-auto border border-[var(--line)] bg-white p-3 transition-transform duration-500 ease-[var(--motion)] hover:scale-[1.015] md:mx-0"
