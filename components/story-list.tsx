      ...
      {publicStories.map((story, index) => {
        ...
        return (
          <Link
            ...
            className="story-index-card group block"
          >
            <div className="flex items-start justify-between gap-6">
              <div className="space-y-3">
                <p className="section-kicker">{storyTypeLabel(story.type)}</p>
                <h3 className="font-display-en text-[1.55rem] leading-[1.02] tracking-[-0.035em] transition-colors group-hover:text-[var(--muted)] md:text-[1.95rem]">
                  {title}
                </h3>
              </div>
